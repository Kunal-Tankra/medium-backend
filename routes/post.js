...
import { createPost, getAllPosts, getCategoryPosts, getPostDetails, getPostsByUserId } from '../controllers/posts.js'
...
router.get('/api/v1/posts/:user', isAuthenticated, getPostsByUserId)
